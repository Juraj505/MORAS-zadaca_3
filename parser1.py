...
class Parser:
    from parseLines1 import _parse_lines, _parse_line
    from parseSymbs1 import _init_symbols, _parse_symbols, _parse_labels, _parse_variables
    from parseComms1 import _init_comms, _parse_command, _parse_commands
    from parseMacros1 import _parse_macros, _parse_macro
